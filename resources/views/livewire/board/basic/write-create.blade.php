                                            ...
                                            @if (auth()->check() && auth()->user()->group_level >= 11)
                                                <div class="flex col-span-6 space-x-5">
                                                    <div class="flex items-center">
                                                        <input type="checkbox" wire:model="is_notice" id="is_notice" value="1" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded dark:bg-gray-700 dark:border-gray-600">
                                                        <label for="is_notice" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300 ml-1">공지</label>
                                                    </div>
                                                </div>
                                            @endif
