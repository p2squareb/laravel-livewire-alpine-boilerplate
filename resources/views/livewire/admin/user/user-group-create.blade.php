<div class="w-full bg-white rounded-md shadow dark:bg-gray-800 lg:px-2">
    ...
    <div class="p-3 space-y-3">
        <div class="grid grid-cols-6 gap-3">
            <div class="col-span-6 sm:col-span-3">
                ...
                <input type="text" id="name" wire:model="name" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-md focus:border-blue-500 block w-full p-[7px] dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:border-blue-500" placeholder="그룹명">
    ...
    <div class="text-right p-3 mb-3 border-t border-gray-200 rounded-b dark:border-gray-700">
        <button wire:click.prevent="createUserGroup" class="text-white bg-blue-700 hover:bg-blue-800 font-medium rounded-md text-sm px-5 py-[7px] text-center dark:bg-blue-600 dark:hover:bg-blue-700" type="button">저장</button>
    </div>
