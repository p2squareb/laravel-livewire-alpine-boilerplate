<footer class="w-full max-w-screen-xl mx-auto h-full overflow-y-auto bg-gray-100 dark:bg-gray-900 md:flex md:items-center md:justify-between px-4 2xl:px-0 py-6 md:py-10">
    <p class="text-sm text-center text-gray-500 mb-4 md:mb-0">
        &copy; <a href="https://flowbite.com//" class="hover:underline" target="_blank">psquare.com</a>. All rights reserved.
    </p>
